...
class FoodCard extends StatelessWidget {
  ...
  List<Color> _gradient() {
    final i = item.title.codeUnitAt(0) % _gradients.length;
    return _gradients[i];
  }

  String _emoji() {
    final i = item.title.codeUnitAt(0) % _emojis.length;
    return item.imageUrl.isEmpty ? _emojis[i] : '';
  }
              ...
              child: SizedBox(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    // Halal badge bottom-left
                    if (item.isHalal)
                      const Positioned(
                          bottom: 10, left: 12, child: HalalBadge()),
                  ],
                ),
              ),
            ),
